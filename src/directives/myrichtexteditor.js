 ...
 * # myRichTextEditor
 */
//import wysihtml5 from 'wysihtml/src/wysihtml5';
//import wysihtml5ParserRules from '../lib/wysihtml5/parser_rules_advanced';
//import wysihtml5ParserRules from 'wysihtml/parser_rules';
//require("../lib/wysihtml5/parser_rules_advanced.js");
...
export default function myRichTextEditor($timeout, $mdDialog, exam) {
  'use strict';
  var shortcuts = {
  ...
  return {
    ...
    require: '?ngModel',
    transclude: true,
    template: require('../views/myrichtexteditor.html'),
    scope: {
      'content': '=ngModel'
    },
    link: function (scope, element, attrs, ngModel) {
      ...
      scope.showGraphicsManager = function ($event) {
        $mdDialog.show({
          ...
          templateUrl: '/src/views/graphicsmanager.html',
          targetEvent: $event,
      ...
      function initEditor() {
        ...
        scope.showGraphicsSettings = function ($event, graphics) {
          $mdDialog.show({
            ...
            targetEvent: $event,
            templateUrl: '/src/views/promptdialog.html',
          ...
          editor.composer.editableArea.addEventListener('click', function (event) {
            ...
            if (codeElement) {
              ...
              $mdDialog.show({
                clickOutsideToClose: false,
                targetEvent: event,
                templateUrl: '/src/views/codeeditor.html',
